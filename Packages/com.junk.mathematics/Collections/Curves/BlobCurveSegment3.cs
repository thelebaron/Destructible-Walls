...
Junk.Collections
{
    ...
    public struct BlobCurveSegment3
    {
        ...
        public float3 Sample(float4 timeSerial) => math.mul(timeSerial, this.Factors);
        ...
        public BlobCurveSegment3(Keyframe k0x, Keyframe k0y, Keyframe k0z, Keyframe k1x, Keyframe k1y, Keyframe k1z)
        {
            Assert.IsTrue(
                ...
                Mathf.Approximately(k0x.time, k0z.time) && Mathf.Approximately(k1x.time, k1z.time), "Time not sync");
