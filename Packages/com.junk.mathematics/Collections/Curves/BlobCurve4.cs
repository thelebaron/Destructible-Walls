...
namespace Junk.Collections
{
    ...
    public struct BlobCurve4 : IBlobCurve<float4>
    {
        ...
        internal BlobArray<BlobCurveSegment4> Segments;
        ...
        public static ref BlobCurve4 Create(ref BlobBuilder builder, ref BlobCurve4 data, AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ, AnimationCurve curveW, Allocator allocator = Allocator.Persistent)
        {
            ...
            if (hasOnlyOneKeyframe)
            {
                ...
                [0] = new BlobCurveSegment4(key0x, key0y, key0z, key0w, key0x, key0y, key0z, key0w);
        ...
        public static BlobAssetReference<BlobCurve4> Create(AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ, AnimationCurve curveW, Allocator allocator = Allocator.Persistent)
        {
            InputCurveCheck(curveX, curveY, curveZ, curveW);
            var xKeys = curveX.keys;
            var yKeys = curveY.keys;
          ...
          Allocator allocator = Allocator.Persistent)
        {
            ...
            {
                var v0 = vertices[0];
                builder.Allocate(ref data.Segments, 1)[0] = BlobCurveSegment4.Linear4(v0, v0);
                var timeBuilder = builder.Allocate(ref data.m_Header.Times, 4);
        ...
        public static BlobAssetReference<BlobCurve4> Create(
          List<float4> vertices, List<float4x2> cvs, List<float> times,
        ...
        static void InputCurveCheck(AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ, AnimationCurve curveW)
        {
            ...
            for (int i = 0, len = xKeys.Length; i < len; i++)
            {
                ...
                {
                    Debug.LogWarning($"Weight Not Supported! Z Key[{i},Weight[{kw.weightedMode},In{kw.inWeight},Out{kw.outWeight}],Time{kw.time},Value{kw.value}]");
                }
            }
        }
    }
