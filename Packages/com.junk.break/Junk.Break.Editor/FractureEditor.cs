                ...
                if (GUILayout.Button("New fracture"))
                {
                    ...
                    if (!string.IsNullOrEmpty(path))
                    {
                        ...
                        if (insideMaterial == null)
                        {
                            ...
                            asset.InsideMaterial = AssetDatabase.LoadAssetAtPath<Material>("Packages/com.junk.break/Junk.Break/Materials/InsideMaterial.mat");
                        ...
                        if (outsideMaterial == null)
                        {
                            ...
                            asset.OutsideMaterial = AssetDatabase.LoadAssetAtPath<Material>("Packages/com.junk.break/Junk.Break/Materials/OutsideMaterial.mat");
