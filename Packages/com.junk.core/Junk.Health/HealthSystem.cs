...
namespace Junk.Health
{
    ...
    public partial struct HealthSystem : ISystem
    {
            ...
            public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
            {
                ...
                for (var i = 0; i < chunk.Count; i++)
                {
                    ...
                    if (hasHealthData)
                    {
                        ...
                        healthData.TakeDamage(totalDamage, false);
        ...
        [BurstCompile]
        [WithAll(typeof(SimpleDestroy))]
        [WithDisabled(typeof(Destroy))]
        public partial struct SimpleDestroyJob : IJobEntity
        {
            public void Execute(in HealthData healthData, EnabledRefRW<Destroy> destroy)
            {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            state.Dependency = new SimpleDestroyJob().Schedule(state.Dependency);
